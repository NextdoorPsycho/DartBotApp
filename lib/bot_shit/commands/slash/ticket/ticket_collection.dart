...
import 'package:shit_ui_app/bot_shit/utils/nyxx_betterment/d_message.dart';
import 'package:shit_ui_app/bot_shit/utils/nyxx_betterment/d_permissions.dart';
import 'package:shit_ui_app/bot_shit/utils/prefab/embed.dart';
...
ChatGroup get ticketCluster => ChatGroup("ticket",
        ...
        children: [
          ChatCommand(
            ...
            id('build-hub', (ChatContext context) async {
              if (context.guild == null) {
                error(
                    "Guild is null - Cannot proceed with 'build-hub' command.");
                return;
              }
              ...
              verbose(
                  "Ticket Hub Category '${ticketHubCategory.name}' is ready.");
              ...
              if (ticketHubChannel == null ||
                  ticketHubChannel is! TextChannel) {
                error(
                    "Failed to create/find 'ticket-hub' channel in category '${ticketHubCategory.name}'.");
                return;
              }
              verbose(
                  "Ticket Hub Channel '${ticketHubChannel.name}' is ready.");
              ...
              await DMessage.sendMessage(
                  entity: ticketHubChannel as TextChannel,
          ...
          ChatCommand(
              ...
              id(
                ...
                (ChatContext context) async {
                  if (context.guild == null) {
                    error(
                        "Guild is null - Cannot proceed with 'create' command.");
                    return;
                  }
          ...
          ChatCommand(
              ...
              id(
                ...
                (
                  ...
                  String? function,
                  @Description(
                      'The user to add or remove. (Right-click Copy ID)')
                  String? userId,
                ]) async {
                  verbose(
                      "Started command 'users' in guild: ${context.guild!.name}");
                  if (userId == null) {
                    context.respond(
                        MessageBuilder(
                            content:
